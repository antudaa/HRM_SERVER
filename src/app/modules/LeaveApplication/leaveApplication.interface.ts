...
//   history: {
//     status: TApplicationStatusTimeline["status"];
...
//   listPaged(
//     filters?: TApplicationSearchFilters,
//     paging?: TPagination
//   ): Promise<{ data: TGeneralApplication[]; total: number }>;
//   addComment(
//     appId: Types.ObjectId,
//     stageIndex: number,
//     comment: Omit<TCommentThread, "_id" | "createdAt"> & { createdAt?: Date }
//   ): Promise<TGeneralApplication | null>;
//   advanceStage(
//     appId: Types.ObjectId,
//     approverId: Types.ObjectId,
